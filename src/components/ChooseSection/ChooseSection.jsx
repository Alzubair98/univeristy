  ...
  return (
    <div>
      <div className="container">
        <h2 className="text-center mb-5 ">why choose my University?</h2>
            ...
            <Card className="d-flex align-items-center border-0 h-100">
              ...
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  ...
                  suspendisse sed nisi lacus sed viverra tellus in. Dignissim
                  enim sit amet venenatis urna cursus. Non tellus orci ac
                  auctor.
                </Card.Text>
              </Card.Body>
            </Card>
